  ...
  return (
    <View style={styles.columnContainer}>
      ...
      <Image
        style={styles.image}
        source={{
          url: "https://user-images.githubusercontent.com/43158356/169729772-77ac1662-35bb-4fea-bedc-224ae0562e19.png",
        }}
      />
      <View style={{ flexDirection: "row", marginTop: 16 }}>
        <Ionicons name="water-outline" color={"white"} size={20} />
        <Text style={styles.percentage}>{data[2]?.humidity}%</Text>
      </View>

      <Text style={styles.temp}>{Math.ceil(data[2]?.temp)}°C</Text>
