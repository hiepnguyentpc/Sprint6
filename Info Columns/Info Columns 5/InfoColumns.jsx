  ...
  return (
    <View style={styles.columnContainer}>
      ...
      <Image
        style={styles.image}
        source={{
          url: "https://user-images.githubusercontent.com/43158356/169729797-cfaefbf3-8fe2-4fd3-a7a2-5af00f71e46f.png",
        }}
      />
      <View style={{ flexDirection: "row", marginTop: 16 }}>
        <Ionicons name="water-outline" color={"white"} size={20} />
        <Text style={styles.percentage}>{data[4]?.humidity}%</Text>
      </View>

      <Text style={styles.temp}>{Math.ceil(data[4]?.temp)}°C</Text>
